...
<p class="standardSchriftBold"><?php 
	if ($sprache == "en"){
		...
		?>
		Installation wird durchgef�hrt ... 
	<?php 
	}	
	?>
</p>
...
?>
<p class="standardSchrift"><?php echo(getUebersetzung("Teil 3 abgeschlossen",$sprache,$link)); ?></p>

<?php if ($fehler == true) { ?><p class="belegt"><?php echo($antwort); ?></p><?php } ?>

<p class="standardSchriftBold"><?php echo(getUebersetzung("So k�nnen sie Rezervi verlinken",$sprache,$link)); ?>:</p>
<ul>
  ...
  <li class="standardSchrift"><?php echo(getUebersetzung("Dieser Seite k�nnen Sie auch die gew�nschte Sprache �bergeben",$sprache,$link)); ?>:<br/>
  ...
  <li class="standardSchrift"><?php echo(getUebersetzung("Sie k�nnen auch direkt die Suchfunktion aufrufen",$sprache,$link)); ?>:<br/>
  ...
  <li class="standardSchrift"><?php echo(getUebersetzung("Auch dieser Seite kann die gew�nschte Sprache �bergeben werden",$sprache,$link)); ?>: <br/>
  ...
  <li class="standardSchrift"><?php echo(getUebersetzung("Den Zugang zur Webschnittstelle erhalten sie �ber",$sprache,$link)); ?>
  (<?php echo(getUebersetzung("Verwenden sie als Benutzername und Passwort \"test\" und �ndern sie das Passwort nach erstmaligem Einstieg.",$sprache,$link)); ?>):<br/>
...
<p class="standardSchrift"><?php echo(getUebersetzung("Nach erfolgreicher Installation sollten Sie den Ordner &quot;install&quot; auf Ihrem Webserver l�schen, ansonsten kann durch einen Angriff von aussen Ihre Datenbank ver�ndert werden",$sprache,$link)); ?>!</p>
