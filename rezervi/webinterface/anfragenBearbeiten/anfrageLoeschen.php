...
if (checkPass($benutzername, $passwort, $unterkunft_id, $link))
{
		...
		else
		{
			...
			if ($temp == "")
			{
				...
				else
				{
                    ...
                    <table border="0" cellpadding="0" cellspacing="3" class="frei">
                        <tr>
                            <td><?php echo(getUebersetzung("Der Gast wurde aus der Datenbank entfernt", $sprache, $link)); ?>
                                .
                            </td>
                        </tr>
                    </table>
			...
			else
			{
                ...
                <table border="0" cellpadding="0" cellspacing="3" class="belegt">
                    <tr>
                        <td><?php echo(getUebersetzung("Der Gast kann nicht entfernt werden, es sind weitere Belegungen/Reservierungen für diesen Gast eingetragen", $sprache, $link)); ?>
                            !
                        </td>
                    </tr>
                </table>
    ...
    <table border="0" cellpadding="0" cellspacing="3" class="tableColor">
        <tr>
            <td>
                <p class="frei"><?php echo(getUebersetzung("Die Reservierungsanfrage", $sprache, $link)); ?>
				...
				?>
                <p><?php echo(getUebersetzung("Die folgende Mitteilung wird per E-Mail an Ihren Gast gesendet. Sie haben hier die Möglichkeiten noch Korrekturen vorzunehmen", $sprache, $link)); ?>
                    :</p>
                <form action="./bestaetigungSenden.php" method="post" name="bestaetigungSenden" target="_self">
                    ...
                    <table border="0" cellpadding="0" cellspacing="3" class="tableColor">
                        <tr valign="top">
                            ...
                            <td><input name="subject" type="text" class="table" id="subject_de"
                                       value="<?php echo($subject); ?>" size="100"></td>
                        </tr>
                        <tr valign="top">
                            <td><?php echo(getUebersetzung("Text", $sprache, $link)); ?></td>
                            <td><textarea name="message" cols="100" rows="10" class="table"
                                          id="text_de"><?php echo($message); ?></textarea></td>
                        </tr>
                    </table>
                    <br/>
					<?php
