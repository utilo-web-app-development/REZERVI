...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <table border="0" cellspacing="0" cellpadding="0" class="table">
            <tr>
                <td><span class="standardSchriftBold"><?php echo(getUebersetzung("Anfrage von", $sprache, $link)); ?>
                        :</span> <?php echo(getGuestVorname($gast_id, $link) . " " . getGuestNachname($gast_id, $link)); ?>
                </td>
            </tr>
            <tr>
                <td><span class="standardSchriftBold"><?php echo(getUebersetzung("Zeitraum", $sprache, $link)); ?>
            ...
            ?>
            <tr>
                <td><span class="standardSchriftBold"><?php echo(getUebersetzung("Personen", $sprache, $link)); ?>
            ...
            <form action="./anfrageBestaetigen.php" method="post" name="reservierungBestaetigen" target="_self"
