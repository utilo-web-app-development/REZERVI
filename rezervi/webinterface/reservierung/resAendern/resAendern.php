                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="alert alert-danger" role="alert">
                            <h4><?php echo(getUebersetzung("Das Reservierungs-Datum wurde nicht korrekt angegeben", $sprache, $link)); ?>
                                !</h4>
                            <h4><?php echo(getUebersetzung("Bitte korrigieren Sie das Datum", $sprache, $link)); ?>
                                !</h4>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="btn-group" data-toggle="buttons">
                                    <?php  if (getPropertyValue(PENSION_FRUEHSTUECK, $unterkunft_id, $link) == "true") {
                                        ...
                                        <label class="btn btn-danger active">
                                            <input type="radio" name="zusatz" id="fruehstueck" autocomplete="off" value="Fruehstueck" > <?php echo(getUebersetzung("Frühstück", $sprache, $link)); ?>
                                        </label>
                                    <?php } ?>
                                    <?php
                                    if (getPropertyValue(PENSION_HALB, $unterkunft_id, $link) == "true") {
                                        ...
                                        <label class="btn btn-success">
                                            <input type="radio" name="zusatz" id="halbpension" autocomplete="off" value="Halbpension"> <?php echo(getUebersetzung("Halbpension", $sprache, $link)); ?>
                                        </label>
                                        <?php
                                    }
                                if (getPropertyValue(PENSION_VOLL, $unterkunft_id, $link) == "true") {
                                    ...
                                    <label class="btn btn-primary">
                                        <input type="radio" name="zusatz" id="vollpension" autocomplete="off" value="Vollpension" checked> <?php echo(getUebersetzung("Vollpension", $sprache, $link)); ?>
                                    </label>
                                    <?php } ?>
                                </div>
                            </div>
                ...
                <?php } //ende if status != frei
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-8 col-sm-2" style="text-align: right;">
                            <form name="zimmerFrei" method="post" action="./resEntfernen.php" target="_self" class="form-horizontal">
                                <input name="zimmer_id" type="hidden" id="zimmer_id" value="<?php echo $zimmer_id ?>">
                                <input name="vonTag" type="hidden" id="vonTag" value="<?php echo $vonTag ?>">
                                <input name="bisTag" type="hidden" id="bisTag" value="<?php echo $bisTag ?>">
                                <input name="vonMonat" type="hidden" id="vonMonat" value="<?php echo $vonMonat ?>">
                        ...
                        <div class="col-sm-2">
                            <form action="../ansichtWaehlen.php" method="post" name="adresseForm" target="_self" class="form-horizontal"
                                  id="adresseForm">
                                <input name="zimmer_id" type="hidden" id="zimmer_id" value="<?php echo($zimmer_id); ?>">
