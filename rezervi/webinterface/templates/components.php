...
function showSubmitButtonWithForm($path, $value)
{
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="table">
        <tr>
            <td>
                <form action="<?php echo($path); ?>" method="post" name="hauptmenue" target="_self" id="hauptmenue">
                    <input name="<?php echo($value); ?>" type="submit" class="btn btn-primary"
                           id="<?php echo($value); ?>" onMouseOver="this.className='button200pxB';"
