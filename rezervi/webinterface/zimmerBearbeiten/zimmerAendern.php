    ...
    <div class="panel-body">
        ...
        <form action="./zimmerAendernDurchfuehren.php" method="post" name="zimmerAendern" id="zimmerAendern"
			...
			if (isGermanShown($unterkunft_id, $link))
			{
                ...
                <div class="form-group">
                    <label for="zimmerart" class="col-sm-7 ">
			...
			if (isEnglishShown($unterkunft_id, $link))
			{
                ...
                <div class="form-group">
                    <label for="zimmerart_en"
                           class="col-sm-7 "><?php echo(getUebersetzung("Zimmerart in englisch", $sprache, $link)); ?>
			...
			if (isFrenchShown($unterkunft_id, $link))
			{
                ...
                <div class="form-group">
                    <label for="zimmerart_fr"
                           class="col-sm-7 "><?php echo(getUebersetzung("Zimmerart in französisch", $sprache, $link)); ?>
			...
			if (isItalianShown($unterkunft_id, $link))
			{
                ...
                <div class="form-group">
                    <label for="zimmerart_it"
                           class="col-sm-7 "><?php echo(getUebersetzung("Zimmerart in italienisch", $sprache, $link)); ?>
			...
			if (isNetherlandsShown($unterkunft_id, $link))
			{
                ...
                <div class="form-group">
                    <label for="zimmerart_nl"
                           class="col-sm-7 "><?php echo(getUebersetzung("Zimmerart in holländisch", $sprache, $link)); ?>
			...
			if (isEspaniaShown($unterkunft_id, $link))
			{
                ...
                <div class="form-group">
                    <label for="zimmerart_sp"
                           class="col-sm-7 "><?php echo(getUebersetzung("Zimmerart in spanisch", $sprache, $link)); ?>
			...
			if (isEstoniaShown($unterkunft_id, $link))
			{
				...
				?>
                <div class="form-group">
                    <label for="zimmerart_es" class="col-sm-7 ">
			...
			if (isGermanShown($unterkunft_id, $link))
			{
				?>
                <div class="form-group">
                    <label for="zimmernr" class="col-sm-7  ">
			...
			if (isEnglishShown($unterkunft_id, $link))
			{
				?>
                <div class="form-group">
                    <label for="zimmernr_en" class="col-sm-7  ">
			...
			if (isFrenchShown($unterkunft_id, $link))
			{
				?>
                <div class="form-group">
                    <label for="zimmernr_fr" class="col-sm-7  ">
			...
			if (isItalianShown($unterkunft_id, $link))
			{
				?>
                <div class="form-group">
                    <label for="zimmernr_it" class="col-sm-7  ">
			...
			if (isNetherlandsShown($unterkunft_id, $link))
			{
				?>
                <div class="form-group">
                    <label for="zimmernr_nl" class="col-sm-7  ">
			...
			if (isEspaniaShown($unterkunft_id, $link))
			{
				?>
                <div class="form-group">
                    <label for="zimmernr_sp" class="col-sm-7  ">
			...
			if (isEstoniaShown($unterkunft_id, $link))
			{
				?>
                <div class="form-group">
                    <label for="zimmernr_es" class="col-sm-7  ">
			...
			?>
            <div class="form-group">
                <label for="betten" class="col-sm-7  ">
            ...
            <div class="form-group">
                <label for="bettenKinder" class="col-sm-7  ">
            ...
            <div class="form-group">
                <label for="linkName" class="col-sm-7  ">
			...
			if (getPropertyValue(SHOW_ZIMMER_ATTRIBUTE_GESAMTUEBERSICHT, $unterkunft_id, $link) == "true")
			{
				...
				while ($d = mysqli_fetch_array($res))
				{
					...
					?>
                    <div class="form-group">
                        <label for="attWert_<?php echo $att_id ?>" class="col-sm-7  ">
