	...
	<tr> 
	  ...
	  <td>
	    <select name="Haustiere" id="Haustiere">
			<option value="true" <?php if ($haustiere == "true") echo("selected=\"selected\""); ?>><?php echo(getUebersetzung("ja",$sprache,$link));?></option>
            <option value="false" <?php if ($haustiere == "false") echo("selected=\"selected\""); ?>><?php echo(getUebersetzung("nein",$sprache,$link));?></option>
	   </select>
		  </td>
    <tr> 
      <td height="30" colspan="2">&nbsp;</td>
