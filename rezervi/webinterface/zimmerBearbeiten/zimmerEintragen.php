    ...
    <div class="panel-body">
        ...
        if (checkPass($benutzername, $passwort, $unterkunft_id, $link)) {
            ...
            if ((($standardsprache == "de") && ($zimmernr == false || !isset($zimmernr))) ||
                ...
                ?>
                <div class="alert alert-danger" role="alert">
                    <?php echo(getUebersetzung("Bitte geben Sie die Anzahl der Betten für Kinder und Erwachsene ein!", $sprache, $link)); ?>
                </div>
                ...
                if ($zimmer_id == false) {
                    ...
                    <div class="alert alert-success" role="alert">
                        <?php echo(getUebersetzung("Zimmer/Appartement/etc. erfolgreich eingetragen", $sprache, $link)); ?>.
                    </div>
                ...
                if ($anzahlVorhandenerZimmer < $anzahlZimmer) {
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <form action="./zimmerAnlegen.php" method="post" name="zimmer aendern" target="_self"
                                  id="zimmer aendern">
                                <input name="retour" type="submit" class="btn btn-success" id="retour"
                                       value="<?php echo(getUebersetzung("ein weiteres anlegen", $sprache, $link)); ?>">
                            </form>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-offset-11 col-sm-1">
                        <form action="./index.php" method="post" name="zimmer aendern" target="_self" id="zimmer aendern">
                            <input name="retour2" type="submit" class="btn btn-primary" id="retour2"
