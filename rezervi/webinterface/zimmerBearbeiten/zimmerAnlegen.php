...
<div class="panel panel-default">
    <div class="panel-body">
        ...
        <form action="./zimmerEintragen.php" method="post" name="zimmerEintragen" target="_self"
            ...
            <h5><?php echo(getUebersetzung("Bitte füllen Sie die untenstehenden Felder aus.", $sprache, $link)); ?><?php echo(getUebersetzung("Die mit [*] gekennzeichneten Felder müssen ausgefüllt werden", $sprache, $link)); ?>
                !</h5>
	      ...
	      <td width="50%"><input name="zimmerart" type="text" id="zimmerart" value="<?php if (isset($zimmerart)) {
                    echo($zimmerart);
                } ?>" maxlength="30"></td>
	    </tr> -->
                <div class="form-group">
                    <label for="zimmerart"
                           class="col-sm-7 control-label"><?php echo(getUebersetzung("Zimmerart in deutsch", $sprache, $link)); ?>
                        <?php echo(getUebersetzung("(z. B. Zimmer, Wohnung, Ferienwohnung, Appartement, etc.)", $sprache, $link)); ?>
                        <?php if ($standardsprache == "de") { ?>
                            *
                        <?php } else {
	      ...
	      <td><input name="zimmerart_es" type="text" id="zimmerart_es"  value="<?php if (isset($zimmerart_es)) {
                    echo($zimmerart_es);
                } ?>" maxlength="30"></td>
	    </tr> -->
                <div class="form-group">
