...
<!-- <form action="./zimmerAendern.php" method="post" name="zimmerAendern" target="_self"> -->
  ...
  <div class="panel-body">
      ...
      <h4><?php echo(getUebersetzung("Zimmer/Appartement/Wohnung/etc. bearbeiten",$sprache,$link)); ?></h4>
         <h5> <?php echo(getUebersetzung("Bitte wählen Sie das zu verändernde Zimmer/Appartement/Wohnung/etc. aus",$sprache,$link)); ?>:</h5>
...
<!-- <form action="./zimmerLoeschenBestaetigen.php" method="post" name="zimmerLoeschen" target="_self"> -->
	<form action="./zimmerLoeschenBestaetigen.php" method="post" name="zimmerLoeschenBestaetigen" target="_self" onSubmit="return chkFormular();" class="form-horizontal">
 </br>
    
      <h4><?php echo(getUebersetzung("Zimmer/Appartement/Wohnung/etc. löschen",$sprache,$link)); ?></h4>
  <h5><?php echo(getUebersetzung("Bitte wählen Sie die zu löschenden Zimmer/Appartement/Wohnung/etc. aus",$sprache,$link)); ?>. <?php echo(getUebersetzung("Sie können mehrere Zimmer/Appartements/Wohnungen/etc. zugleich auswählen und löschen indem Sie die [STRG]-Taste gedrückt halten und auf die Bezeichnung klicken",$sprache,$link)); ?>.</h5>
...
<!--alter buton <td><input name="zimmerAnlegenButton" type="submit" id="zimmerAnlegenButton" class="button200pxA" onMouseOver="this.className='button200pxB';"
  ...
  <a class="btn btn-primary" href="./zimmerAnlegen.php"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>&nbsp;<?php echo(getUebersetzung("Zimmer anlegen",$sprache,$link)); ?></a>
...
<!-- <form action="./bilderHochladen.php" method="post" name="bilder" target="_self" id="bilder"> -->
	<form action="./bilderHochladen.php" method="post" name="bilder" id="bilder" target="_self" onSubmit="return chkFormular();" class="form-horizontal">
...
<form action="./standardpreis.php" method="post" name="preis" target="_self">
      	...
      	<!-- alter button <input 
       	...
       	</br>		<a class="btn btn-primary" href="./standardpreis.php"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>&nbsp;<?php echo(getUebersetzung("Standardpreise bearbeiten",$sprache,$link)); ?></a>
...
<!-- <form action="./attributeHinzufuegen.php" method="post" name="attributeHinzufuegen" target="_self"> -->
  	...
  	<form action="./attributeHinzufuegen.php" method="post" name="attributeHinzufuegen" target="_self" onSubmit="return chkFormular();" class="form-horizontal">
  	</br>
