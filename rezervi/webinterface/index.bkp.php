        ...
        <tr>
            <td align="center" valign="middle">
                    ...
                    <tr>
						...
						if ($noLanguage)
						{
                            ...
                            <td class="ueberschrift" align="right">Welcome at the
								...
								{
									?>
                                    from <a href="<?php echo $resellerUrl ?>" target="_blank"
                                            class="ueberschrift"><?php echo $resellerName ?></a>
									<?php
								}
								else
								{
									?>
                                    <a href="http://www.utilo.eu/" target="_blank" class="ueberschrift">&copy;
                                        utilo.eu</a>
									<?php
								}
								?>
                        ...
                        <td class="ueberschrift"><?php echo(getUebersetzung("Willkommen auf der Wartungsseite", $sprache, $link)); ?>
							...
							{
								?>
                                von <a href="<?php echo $resellerUrl ?>" target="_blank"
                                       class="ueberschrift"><?php echo $resellerName ?></a>
								<?php
							}
							else
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="belegt">
                    <tr>
                        <td>
                            <div align="center"><?php echo(getUebersetzung("Der Benutzername und/oder das Passwort wurden falsch eingegeben, bitte wiederholen Sie Ihre Eingabe!", $sprache, $link)); ?></div>
                        </td>
                    </tr>
                </table>
                <br/>
                ...
                <table border="0" align="center" cellpadding="0" cellspacing="2" class="table">
                    <tr>
                        <td><p align="center" class="standardSchrift"><?php
								...
								echo(getUebersetzung("Bitte melden Sie sich hier mit Ihrem Benutzernamen und Passwort an", $sprache, $link)); ?>
                                :<br/></p>
							<?php
							//keine sprache -> auch englisch anzeigen:
							if ($noLanguage)
							...
							?>
                            <form action="./inhalt.php" method="post" name="passwortEingabe" target="_self"
                                  id="passwortEingabe">
                                <table width="10" border="0" align="center" cellpadding="0" cellspacing="5"
                                    ...
                                    <tr>
                                        ...
                                        <td><input name="pass" class="form-control" type="password" id="pass"></td>
                                    </tr>
                                    <tr>
                                        <td valign="middle"><?php
											//keine sprache -> auch englisch anzeigen:
                                        ...
                                        <td><select class="form-control" name="sprache">
												<?php
                                ...
                                <p align="center">
                                    <input name="anmelden" type="submit" class="btn btn-success" id="anmelden"
                                           value="<?php
									       //keine sprache -> auch englisch anzeigen:
									       if ($noLanguage)
									       {
                ...
                <p><span class="standardSchriftBold"><?php
                    ...
                    <a href="http://utilo.eu" target="_blank"><?php
						//keine sprache -> auch englisch anzeigen:
						if ($noLanguage)
						{
						...
						echo("&gt;&gt; ");
						echo(getUebersetzung("Klicken Sie hier um mehr Informationen zu erhalten!", $sprache, $link)); ?></a>
                </p></td>
        </tr>
        <tr>
            <td align="center" valign="middle">
