...
<form action="./anlegen.php" method="post" name="adresseForm" target="_self" onSubmit="return chkFormular();">
  ...
  <p>
    <input type="submit" name="anlegen" class="button200pxA" onMouseOver="this.className='button200pxB';"
       onMouseOut="this.className='button200pxA';" value="<?php echo(getUebersetzung("Gast anlegen",$sprache,$link)); ?>">
  </p>
</form>
