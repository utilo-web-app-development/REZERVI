...
{
	$fehler  = true;
	$message = getUebersetzung("Bitte geben sie die Währung ein.", $sprache, $link);
}
if ($fehler == true)
{
...
else
{
	...
	if (checkPass($benutzername, $passwort, $unterkunft_id, $link))
	{
		...
		if ($zimmerart_de == false)
		{
			$zimmerart_de = $defaultzimmerart;
		}
		if ($zimmerart_en == false)
		{
			$zimmerart_en = $defaultzimmerart;
		}
		if ($zimmerart_fr == false)
		{
			$zimmerart_fr = $defaultzimmerart;
		}
		if ($zimmerart_it == false)
		{
			$zimmerart_it = $defaultzimmerart;
		}
		if ($zimmerart_nl == false)
		{
			$zimmerart_nl = $defaultzimmerart;
		}
		if ($zimmerart_sp == false)
		{
			$zimmerart_sp = $defaultzimmerart;
		}
		if ($zimmerart_es == false)
		{
			$zimmerart_es = $defaultzimmerart;
		}
		...
		if ($zimmerart_mz_de == false)
		{
			$zimmerart_mz_de = $defaultzimmerart_mz;
		}
		if ($zimmerart_mz_en == false)
		{
			$zimmerart_mz_en = $defaultzimmerart_mz;
		}
		if ($zimmerart_mz_fr == false)
		{
			$zimmerart_mz_fr = $defaultzimmerart_mz;
		}
		if ($zimmerart_mz_it == false)
		{
			$zimmerart_mz_it = $defaultzimmerart_mz;
		}
		if ($zimmerart_mz_nl == false)
		{
			$zimmerart_mz_nl = $defaultzimmerart_mz;
		}
		if ($zimmerart_mz_es == false)
		{
			$zimmerart_mz_es = $defaultzimmerart_mz;
		}
		if ($zimmerart_mz_sp == false)
		{
			$zimmerart_mz_sp = $defaultzimmerart_mz;
		}
