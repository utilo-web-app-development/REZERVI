...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    if ($benutzerrechte >= 1 && $anzahlVorhandenerZimmer > 0) {
        ...
        <div class="row">
            <div class="col-sm-3">
                <a href="./reservierung/index.php" role="button" class="btn btn-default" name="resEingebenAendern" style="width: 100%;"
                   target="_self">
        ...
        <div class="row">
            <div class="col-sm-3">
                <a href="./anfragenBearbeiten/index.php" role="button" class="btn btn-default" name="anfragenBearbeiten" style="width: 100%;"
                   target="_self">
        ...
        <div class="row">
            <div class="col-sm-3">
                <a href="./gaesteBearbeiten/index.php" role="button" class="btn btn-default" name="gaesteBearbeiten" style="width: 100%;"
                   target="_self">
    ...
    if ($benutzerrechte == 1) {
        ...
        <div class="row">
            <div class="col-sm-3">
                <a href="" role="button" class="btn btn-default" name="Benutzerdatenbearbeiten" target="_self" style="width: 100%;">
    ...
    if ($benutzerrechte >= 2) {
        ...
        <div class="row">
            <div class="col-sm-3">
                <a href="./benutzerBearbeiten/index.php" role="button" class="btn btn-default" style="width: 100%;"
    ...
    if ($benutzerrechte >= 2) {
        ...
        <div class="row">
            <div class="col-sm-3">
                <a href="./zimmerBearbeiten/index.php" role="button" class="btn btn-default" name="zimmerBearbeiten" style="width: 100%;"
                   target="_self">
        ...
        <div class="row">
            <div class="col-sm-3">
                <a href="#" role="button" class="btn btn-default" name="zimmerBearbeiten" target="_self" style="width: 100%;">
                    <?php echo(getUebersetzung("Zimmer bearbeiten", $sprache, $link)); ?>
                </a>
            </div>
            <div class="col-sm-9">
    ...
    if ($benutzerrechte >= 2) {
        ...
        <div class="row">
            <div class="col-sm-3">
                <a href="./unterkunftBearbeiten/index.php" role="button" class="btn btn-default" style="width: 100%;"
        ...
        <div class="row">
            <div class="col-sm-3">
                <a href="#" role="button" class="btn btn-default" name="UnterkunftBearbeiten" target="_self" style="width: 100%;">
                    <?php echo(getUebersetzung("Unterkunft bearbeiten", $sprache, $link)); ?>
                </a>
            </div>
            <div class="col-sm-9">
    ...
    if ($benutzerrechte >= 2) {
        ...
        <div class="row">
            <div class="col-sm-3">
                <a href="./divEinstellungen/index.php" role="button" class="btn btn-default" name="DiverseEinstellungen" style="width: 100%;"
                   target="_self">
        ...
        <div class="row">
            <div class="col-sm-3">
                <a href="#" role="button" class="btn btn-default" name="DiverseEinstellungen" target="_self" style="width: 100%;">
                    <?php echo(getUebersetzung("Diverse Einstellunge", $sprache, $link)); ?>
                </a>
            </div>
            <div class="col-sm-9">
    ...
    if ($benutzerrechte >= 2) {
        ...
        <div class="row">
            <div class="col-sm-3">
                <a href="../webinterface/designBearbeiten/index.php" role="button" class="btn btn-default" style="width: 100%;"
    ...
    if ($benutzerrechte == 1) {
        ...
        <div class="row">
            <div class="col-sm-3">
                <a href="" role="button" class="btn btn-default" name="designBearbeiten" target="_self" style="width: 100%;">
                    <?php echo(getUebersetzung("Design bearbeiten", $sprache, $link)); ?>
                </a>
            </div>
            <div class="col-sm-9">
    ...
    if ($benutzerrechte >= 2) {
        ...
        <div class="row">
            <div class="col-sm-3">
                <a href="./autoResponse/index.php" role="button" class="btn btn-default" name="antwortenBearbeiten" style="width: 100%;"
                   target="_self">
    ...
    if ($benutzerrechte == 1) {
        ...
        <div class="row">
            <div class="col-sm-3">
                <a href="" role="button" class="btn btn-default" name="antwortenBearbeiten" target="_self" style="width: 100%;">
                    <?php echo(getUebersetzung("Automatische e-Mails", $sprache, $link)); ?>
                </a>
            </div>
            <div class="col-sm-9">
    ...
    <div class="row">
        <div class="col-sm-3">
            <a href="http://www.rezervi.com/joomlaRezervi/index.php/rezervi-belegungsplan/dokumentation" role="button" style="width: 100%;"
    ...
    if ($benutzerrechte >= 1) {
        ...
        <div class="row">
            <div class="col-sm-3">
                <a href="./abmelden.php" role="button" class="btn btn-default" name="abmelden" target="_blank" style="width: 100%;">
