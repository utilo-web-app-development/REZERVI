...
if (checkPass($benutzername, $passwort, $unterkunft_id, $link))
{
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            <a href="./sprachen/sprachen.php " name="sprachen" class="btn btn-primary" id="sprachen"
               style="width: 100%;">
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            <a href="./standardSprache/index.php" name="standard-Sprache" class="btn btn-primary" id="standard-Sprache"
               style="width: 100%;">
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            <a href="./buchungseinschraenkungen/index.php" name="buchungeinschränken" type="submit"
               class="btn btn-primary" id="buchungeinschränken" style="width: 100%;">
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            <a href="./bilder/index.php" name="bilder" type="submit" class="btn btn-primary" id=bilder"
               style="width: 100%;">
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            <a href="./belegungsplan/index.php" name="belegungsplan" type="submit" class="btn btn-primary"
               id=belegungsplan" style="width: 100%;">
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            <a href="./reservierungen/index.php" name="reservierungen" type="submit" class="btn btn-primary"
               id=reservierungen" style="width: 100%;">
    ...
    <div class="col-sm-2">
        <a href="./buchungsformular/index.php" name="buchungsformular" type="submit" class="btn btn-primary"
           id=buchungsformular" style="width: 100%;">
