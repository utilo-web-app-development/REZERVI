...
var ZCounter = 100;
var Today = new Date();
var WeekDays = new Array('<?= getUebersetzung(SONNTAG,$sprache,$link) ?>','<?= getUebersetzung(MONTAG,$sprache,$link) ?>','<?= getUebersetzung(DIENSTAG,$sprache,$link) ?>','<?= getUebersetzung(MITTWOCH,$sprache,$link) ?>','<?= getUebersetzung(DONNERSTAG,$sprache,$link) ?>','<?= getUebersetzung(FREITAG,$sprache,$link) ?>','<?= getUebersetzung(SAMSTAG,$sprache,$link) ?>');
var MonthDays = new Array(31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31);
var MonthNames = new Array('<?= getUebersetzung("Januar",$sprache,$link) ?>','<?= getUebersetzung("Februar",$sprache,$link) ?>','<?= getUebersetzung("März",$sprache,$link) ?>','<?= getUebersetzung("April",$sprache,$link) ?>','<?= getUebersetzung("Mai",$sprache,$link) ?>','<?= getUebersetzung("Juni",$sprache,$link) ?>','<?= getUebersetzung("Juli",$sprache,$link) ?>','<?= getUebersetzung("August",$sprache,$link) ?>','<?= getUebersetzung("September",$sprache,$link) ?>','<?= getUebersetzung("Oktober",$sprache,$link) ?>','<?= getUebersetzung("November",$sprache,$link) ?>','<?= getUebersetzung("Dezember",$sprache,$link) ?>');
