...
var CellWidth = 18;
var CellHeight = 16;
var ImageURL = './templates/calendar.jpg';
var NextURL = './templates/next.gif';
var PrevURL = './templates/prev.gif';
...
var ZCounter = 100;
var Today = new Date();
var WeekDays = new Array('<?php echo getUebersetzung(SONNTAG,$sprache,$link) ?>','<?php echo getUebersetzung(MONTAG,$sprache,$link) ?>','<?php echo getUebersetzung(DIENSTAG,$sprache,$link) ?>','<?php echo getUebersetzung(MITTWOCH,$sprache,$link) ?>','<?php echo getUebersetzung(DONNERSTAG,$sprache,$link) ?>','<?php echo getUebersetzung(FREITAG,$sprache,$link) ?>','<?php echo getUebersetzung(SAMSTAG,$sprache,$link) ?>');
var MonthDays = new Array(31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31);
var MonthNames = new Array('<?php echo getUebersetzung("Januar",$sprache,$link) ?>','<?php echo getUebersetzung("Februar",$sprache,$link) ?>','<?php echo getUebersetzung("März",$sprache,$link) ?>','<?php echo getUebersetzung("April",$sprache,$link) ?>','<?php echo getUebersetzung("Mai",$sprache,$link) ?>','<?php echo getUebersetzung("Juni",$sprache,$link) ?>','<?php echo getUebersetzung("Juli",$sprache,$link) ?>','<?php echo getUebersetzung("August",$sprache,$link) ?>','<?php echo getUebersetzung("September",$sprache,$link) ?>','<?php echo getUebersetzung("Oktober",$sprache,$link) ?>','<?php echo getUebersetzung("November",$sprache,$link) ?>','<?php echo getUebersetzung("Dezember",$sprache,$link) ?>');
...
function DateInput(DateName, Required, DateFormat, DefaultDate) {
   if (DateName == undefined) document.writeln('<span style="color:red;font-size:' + FontSize + 'px;font-family:' + FontFamily + ';">ERROR: Missing required parameter in call to \'DateInput\': [name of hidden date field].</span>');
      ...
      with (document) {
         ...
         //monat:
         writeln('<select name="' + DateName + '_Month" class="tableColor" onChange="' + DateName + '_Object.changeMonth(this)">');
         if (!Required) {
