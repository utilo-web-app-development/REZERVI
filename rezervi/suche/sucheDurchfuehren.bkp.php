        ...
        <div class="panel-body">
            ...
            if (!isDatumEarlier(
                ...
                <form action="./index.php" id="fehlerRedirectForm">
                    <input type="hidden" name="messageDanger" value="Das Reservierungs-Datum wurde nicht korrekt angegeben!"/>
                    <input type="hidden" name="messageWarning" value="Bitte korrigieren Sie das Datum Ihrer Anfrage!"/>
                    ...
                    <tr>
                        <td>
                            <p class="standardSchriftBold">
                                <?php echo(getUebersetzung(
                                    "Das Reservierungs-Datum wurde nicht korrekt angegeben!",
                                    $sprache, $link
                                )); ?>
                            </p>
                            <p class="standardSchriftBold">
                        ...
                        <td>
                            <form action="./index.php" method="post"
                                ...
                                if (isset($zimmerIdsParents)
                                    ...
                                    ?>
                                    <input name="zimmerIdsParents" type="hidden"
                                           value="<?php
                                           foreach (
                                               $zimmerIdsParents as $ziidpa
                                           ) {
                                               echo($ziidpa . ",");
                                           }
                                           ?>"/>
                                ...
                                <input type="submit" name="Submit"
                                       ...
                                       value="<?php echo(getUebersetzung(
                                           "Suche wiederholen", $sprache, $link
                                       )); ?>">
                            </form>
                        </td>
                    </tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="3"
                        ...
                        <tr>
                            <td>
                                <b>
                                    <?php echo(getUebersetzung(
                                        "Das gewählte Datum ist bereits abgelaufen.",
                                        $sprache, $link
                                    )); ?>
                                </b>
                                <b>
                        ...
                        <tr>
                            <td>
                                <form action="./index.php" method="post"
                                      name="sucheWiederholen" target="_self">
                                    <input name="anzahlErwachsene" type="hidden"
                                           value="<?php echo($anzahlErwachsene); ?>"/>
                                    <input name="anzahlKinder" type="hidden"
                                           value="<?php echo($anzahlKinder); ?>"/>
                        ...
                        <table border="0" cellpadding="0" cellspacing="3"
                            ...
                            <tr>
                                <td>
                                    <b>
                                        <?php echo(getUebersetzung(
                                            "Es ist mindestens eine Übernachtung erforderlich",
                                            $sprache, $link
                                        )); ?>
                                        !
                                    </b>
