    ...
    <form action="../start.php" method="post" name="form1" target="_parent">
        ...
        <form action="../start.php" method="post" name="form1" target="_self">
            ...
            <table border="0" class="table">
                        ...
                        <select name="zimmer_id" size="<?php echo($zimmeranzahl); ?>" class="tableColor">
							...
							while ($d = mysqli_fetch_array($res))
							{
								...
								while ($ergebnis = mysqli_fetch_array($hallo))
								{
									...
									?>
                                    <option value="<?php echo($d["PK_ID"]); ?>"<?php if ($zaehler == 1) echo("selected"); ?>>
										<?php echo($zimmerbezeichnung); ?><!-- <?php echo(" (" . $uebersetzung1 . " " . $monatVon . " " . $uebersetzung2 . " " . $monatBis . " " . $uebersetzung3 . " " . $von . " " . $uebersetzung2 . " " . $bis . ".)"); ?> --></option>
									<?php
								}//end while-loop
								if ($von == "" && $bis == "")
								{
                ...
                <tr>
                    <td><input type="submit" name="Submit" class="button200pxA"
      ...
      ?>
        ...
        <form action="../suche/sucheDurchfuehren.php" method="post" name="suchen" target="_self" id="suchen">
            <table border="0" class="table">
                <tr>
                    <td>
                        <p class="standardSchriftBold">
							...
							?>
                            <span class="standardSchriftBold"><?php echo(getUebersetzung("von", $sprache, $link)); ?>
                                : <br/>
          </span>
                            <script>DateInput('datumVon', true, 'DD/MM/YYYY', '<?php echo($startdatumDP); ?>')</script>
                            <span class="standardSchriftBold"><?php echo(getUebersetzung("bis", $sprache, $link)); ?>
                                :</span><br/>
				...
				?>
                <tr>
                    <td class="standardSchriftBold"><input name="sucheStarten" type="submit" class="button200pxA"
                                                           onMouseOver="this.className='button200pxB';"
                                                           onMouseOut="this.className='button200pxA';" id="sucheStarten"
                    ...
                    <tr>
                        ...
                        <td>
                            <div align="left"><a
                                        ...
                                        target="_self" class="standardSchrift">&nbsp;&nbsp;Francais</a></div>
                        </td>
                    </tr>
					<?php
				}
                    ...
                    <tr>
                        ...
                        <td>
                            <div align="left"><a
                                        ...
                                        target="_self" class="standardSchrift">&nbsp;&nbsp;Nederlands</a></div>
                        </td>
                    </tr>
					<?php
				}
