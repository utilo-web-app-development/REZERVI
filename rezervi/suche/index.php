...
<div class="container" style="margin-top:70px;">
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <form action="../start.php" method="post" name="form1"
				<?php
          ...
          <?php
            ...
            <form action="../suche/sucheDurchfuehren.php" method="post" name="suchen" target="_self" id="suchen">
                ...
                <b><input name="sucheStarten" type="submit" class="btn btn-default" id="sucheStarten"
                          value="<?php echo(getUebersetzung("Suche starten...", $sprache, $link)); ?>"></b>
