    ...
    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="false">
        ...
        foreach ($freieZimmer as $zimmer_id) {
            ...
            <div class="panel panel-default">
                <div class="panel-heading" role="tab" id="heading<?php echo $zimmer_id; ?>">
                    <div>
                        <h5 class="panel-title">
                            <a role="button" data-toggle="collapse" data-parent="#accordion"
                               href="#collapse<?php echo $zimmer_id; ?>" aria-expanded="true"
                               aria-controls="collapse<?php echo $zimmer_id; ?>">
                                <?php
                ...
                <div id="collapse<?php echo $zimmer_id; ?>" class="panel-collapse collapse" role="tabpanel"
                     aria-labelledby="heading<?php echo $zimmer_id; ?>">
