  ...
  <table border="0" cellpadding="0" cellspacing="3"  class="<?php echo STANDARD_SCHRIFT ?>">
    <tr>
      <td colspan="2"><p class="<?php echo STANDARD_SCHRIFT_BOLD ?>"><?php echo(getUebersetzung("Benutzer bearbeiten")); ?><br/>
          <span class="<?php echo STANDARD_SCHRIFT ?>"><?php echo(getUebersetzung("Bitte füllen Sie die untenstehenden Felder aus.")); ?> <?php echo(getUebersetzung("Die mit [*] gekennzeichneten Felder müssen ausgefüllt werden!")); ?></span></p></td>
    </tr>
    <tr>
