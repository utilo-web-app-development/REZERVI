...
<form action="./bilderHochladenDurchfuehren.php" method="post" name="bilderHochladen" 
  ...
  <table border="0" cellpadding="0" cellspacing="3">
	...
	<tr> 
 	...
 	<tr>
		<td><span class="<?= STANDARD_SCHRIFT ?>"><?php echo(getUebersetzung("Mietobjekt")); ?></span></td>
	...
	<tr>
		<td><span class="<?= STANDARD_SCHRIFT ?>"><?php echo(getUebersetzung("Bild")); ?></span></td>
		<td><input name="bild" type="file"/>*</td>
	</tr>
	<tr>
		<td><span class="<?= STANDARD_SCHRIFT ?>"><?php echo(getUebersetzung("Beschreibung")); ?></span></td>
	...
	<tr>
		<td><span class="<?= STANDARD_SCHRIFT ?>"><?php echo(getUebersetzung("Maximale Bildbreite")); ?></span></td>
