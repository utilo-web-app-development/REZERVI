<?php
	...
	/**
	liefert die file Extension eines hochgeladenen bildes
	*/
	function getFileExtension($file_mime_type){
	   $file_extensions = array('image/bmp'=>'.bmp', 'image/gif'=>'.gif', 'image/jpeg'=>'.jpg', 'image/pjpeg'=>'.jpg', 'image/png'=>'.png', 'image/tiff'=>'.tiff' );
	   if (isset($file_extensions[$file_mime_type])){
		  return $file_extensions[$file_mime_type];
	   }else{
		  return '';
	   }
	}
...
require("hft_image_errors.php"); // here you can include your own language error file
	...
	class hft_image {
		...
		var $image_resized;
		var $file_resized;
		var $image_resized_width = 0;
		var $image_resized_height = 0;
