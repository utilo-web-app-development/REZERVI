...
author:coster
date:1.11.05
gibt ein formatiertes datum f�r html aus dem timestamp zur�ck
*/
 ...
 * author:coster
 * date:4.11.05
 * gibt den heutigen tag als 2-stelliger string zur�ck mit f�hrender 0
 * */
 ...
 * author:coster
 * date:4.11.05
 * gibt die aktuelle minute als 2-stelliger string zur�ck mit f�hrender 0
 * */
 ...
 * author:coster
 * date:4.11.05
 * gibt die aktuelle stunde als 2-stelliger string zur�ck mit f�hrender 0
 * */
 ...
 * date:20.10.05
 * change: 4.11.05
 * liefert das heutige monat zur�ck (als int von 1-12) 2-stellig mit f�hrender 0;
 * */
...
/**
 * gibt den wochentag als vollständiger form zurueck
 * author: li haitao
 * date: 15. Nov. 2007
 * @param $tag
 * @param $monat
...
@author coster
@date 27.7.2007
constructs a bookline date - a date as varchar YYYYMMDDHHMM
* */
function constructBooklineDate($year,$month,$day,$hour,$minute){
	if (strlen($month)<2){
		$month = "0".$month;
	}
	if (strlen($day)<2){
...
/**
 @author coster
 @date 17.7.2007
 get the hour from a bookline formated date
 @return hour
 */
function getHourFromBooklineDate($date){
	//z.b. 200707171155
	//     012345678901
...
/**
 @author coster
 @date 17.7.2007
 get the minutes from a bookline formated date
 @return minutes
 */
function getMinuteFromBooklineDate($date){
	//z.b. 200707171155
	//     012345678901
...
/**
 @author coster
 @date 17.7.2007
 get the day from a bookline formated date
 @return day
 */
function getDayFromBooklineDate($date){
	//z.b. 200707171155
	//     012345678901
...
/**
 @author coster
 @date 17.7.2007
 get the month from a bookline formated date
 @return month
 */
function getMonthFromBooklineDate($date){
	//z.b. 200707171155
	//     012345678901
...
/**
 @author coster
 @date 17.7.2007
 get the year from a bookline formated date
 @return year
 */
function getYearFromBooklineDate($date){
	//z.b. 200707171155
	//     012345678901
